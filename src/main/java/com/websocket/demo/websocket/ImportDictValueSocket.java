...
public class ImportDictValueSocket {
    ...
    public void onOpen(Session session) {
        ...
        System.out.println("menber join, current num:" + getOnlineCount());
        try {
            sendMessage("current num:"+getOnlineCount()+",current sessionID:"+this.session.getId());
        } catch (IOException e) {
    ...
    public void onClose() {
        ...
        System.out.println("menber out , current num : " + getOnlineCount());
    }
    ...
    public void onMessage(String message, Session session) throws IOException, InterruptedException {
        System.out.println("the msg from front:" + message);
